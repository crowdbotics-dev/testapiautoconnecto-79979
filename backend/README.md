...
## Project Structure
    ...
    ├── testapiautoconnecto_79979  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_79979`
...
2. Clone this repo and `cd testapiautoconnecto_79979`
